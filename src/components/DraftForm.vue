  ...
  <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
    ...
    <form @submit.prevent="handleSubmit" class="space-y-4">
      ...
      <div class="flex space-x-3">
        ...
        <button type="button" @click="handleCancel" class="px-4 py-2 bg-gray-300 hover:bg-gray-400 text-gray-700 rounded-lg transition-colors">
          {{ t('cancel', language) }}
        </button>
      </div>
    </form>
...
const { user, editingDraft, t, language, contentTypes, draftStatuses, show } = toRefs(props)
